...
# ============================================================
print("="*80)
print(f"4. TARGET ANALYSIS: Overall_Health_Score")
print("="*80)
...
if target in numeric_cols:
    ...
    axes[0].set_title(f"{Overall_Health_Score} Distribution")
    ...
    axes[1].set_title(f"{Overall_Health_Score} Box Plot")
    ...
    plt.title(f"{Overall_Health_Score} Distribution")
    plt.xlabel(target)
    plt.ylabel("Count")
...
report_lines = [
    ...
    'Generated: ' + str(datetime.now())[:19],  # datetime as string
    '',
    '## Overview',
    f'- **Rows:** {df.shape[0]:,}',
